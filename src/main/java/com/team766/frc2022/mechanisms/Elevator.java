...
public class Elevator extends Mechanism {
    ...
    public void setElevatorPower(double power) {
        ...
        if (power < 0 && getElevatorBottom() - getElevatorPosition() >= getElevatorLeniency() && !m_top.get()) {
            m_elevator.set(-power);
        } else if (power > 0 && getElevatorPosition() - getElevatorTop() >= getElevatorLeniency() && !m_bottom.get()) {
            m_elevator.set(-power);
        } else {
            m_elevator.set(0);
        } 
